...
This project aims to reproduce the **visual style of Shanghai Metro 2020-2024 interchange badges**.

The parameters were reverse-engineered from reference photographs and official route map SVGs.  
Because no official design specifications are available, **minor deviations from real signage may remain**.

However, when rendered at the scale typically used in rail maps (such as in RMG route diagrams), the generated badges appear **visually consistent with the original design**.

This implementation prioritizes **consistent parametrization and usability** over pixel-perfect replication.
